<?php
/**
 * Single Property Detail Template
 *
 * @package Estatein
 */
...
<main class="section-wrapper" style="padding-top: 40px;">
    ...
    <div class="property-gallery-container">
        ...
        <div class="gallery-thumbs-row">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/property-1.png" alt="Thumb 1" class="thumb-item active">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/property-2.png" alt="Thumb 2" class="thumb-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/property-3.png" alt="Thumb 3" class="thumb-item">
        ...
        <div class="gallery-main-grid">
            <div class="gallery-main-card">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/property-1.png" alt="Seaside Serenity Villa Exterior">
            </div>
            <div class="gallery-main-card">
    ...
    <section class="faq-section" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="section-header" style="margin-bottom: 40px; display: flex; align-items: flex-end; justify-content: space-between;">
            ...
            <a href="<?php echo esc_url(home_url('/faq')); ?>" class="btn btn-secondary">View All FAQ's</a>
        </div>
