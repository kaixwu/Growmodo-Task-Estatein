...
<section id="testimonials" class="section-wrapper">
    ...
    <div class="testimonials-grid">
        ...
        <div class="testimonial-card">
            ...
            <h3 class="testimonial-title">Smooth Closing Process</h3>
            <p class="testimonial-text">Estatein made buying our penthouse effortless. Their legal advice and swift communication made all the difference.</p>
            <div class="reviewer-profile">
                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80" alt="Sarah Jenkins" class="reviewer-avatar">
                <div class="reviewer-info">
                    <h4>Sarah Jenkins</h4>
                    <p>USA, New York</p>
                </div>
        ...
        <div class="testimonial-card">
            ...
            <h3 class="testimonial-title">Outstanding Market Insight</h3>
            <p class="testimonial-text">Their local real estate data and honest valuation advice helped us land our dream oceanfront villa under budget.</p>
            <div class="reviewer-profile">
                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80" alt="Michael Chang" class="reviewer-avatar">
                <div class="reviewer-info">
                    <h4>Michael Chang</h4>
                    <p>Canada, Toronto</p>
                </div>
        ...
        <div class="testimonial-card">
            ...
            <h3 class="testimonial-title">Professional &amp; Dedicated</h3>
            <p class="testimonial-text">From the initial consultation to handing over the keys, the Estatein team exceeded all our expectations.</p>
            <div class="reviewer-profile">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=150&q=80" alt="Jessica Alba" class="reviewer-avatar">
                <div class="reviewer-info">
                    <h4>Jessica Alba</h4>
                    <p>USA, Florida</p>
                </div>
...
<section id="faq" class="section-wrapper">
    ...
    <div class="faq-grid">
        ...
        <div class="faq-card">
            ...
            <p>The timeline varies based on financing and legal checks, typically ranging from 2 to 6 weeks.</p>
            <a href="<?php echo esc_url(home_url('/contact')); ?>" class="btn btn-secondary">Read More</a>
        </div>

        <div class="faq-card">
            <h3>What documentation do international buyers need?</h3>
            <p>International buyers need valid passport identification, proof of funds, and local tax registration.</p>
            <a href="<?php echo esc_url(home_url('/contact')); ?>" class="btn btn-secondary">Read More</a>
        </div>

        <div class="faq-card">
            <h3>Are there any hidden management or maintenance fees?</h3>
            <p>No. All HOA, maintenance, and transaction fees are fully disclosed upfront in our pricing breakdown.</p>
            <a href="<?php echo esc_url(home_url('/contact')); ?>" class="btn btn-secondary">Read More</a>
        </div>
    </div>
